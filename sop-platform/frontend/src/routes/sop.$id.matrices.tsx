...
import { InlineLoader, PageError } from '../components/PageLoader'
...
function MetricsPage() {
  ...
  if (isLoading) return <InlineLoader label="Loading metrics…" />
  if (!metrics) return <PageError message="Failed to load metrics." />
